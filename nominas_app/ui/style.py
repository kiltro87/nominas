...
div[data-testid="stMetricValue"] { color: var(--m3-on-surface) !important; }
h3, h4, h5 { color: var(--m3-on-primary-container) !important; font-weight: 700 !important; }
...
@media (min-width: 1201px) {
    div[data-testid="column"] > div[data-testid="stVerticalBlockBorderWrapper"] { height: 100% !important; }
    div[data-testid="column"] > div[data-testid="stVerticalBlockBorderWrapper"] > div { height: 100% !important; }
}
@media (max-width: 1200px) {
    div[data-testid="stHorizontalBlock"] { flex-wrap: wrap !important; }
    div[data-testid="column"] { flex: 1 1 280px !important; min-width: 280px !important; }
}
@media (max-width: 760px) {
    div[data-testid="column"] { min-width: 100% !important; flex-basis: 100% !important; }
    div[data-testid="stMetric"] label p { font-size: 0.82rem !important; }
